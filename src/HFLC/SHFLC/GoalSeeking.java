...
public class GoalSeeking {
	...
	public GoalSeeking(double negativeLowerLeft, double negativeLowerRight,
			...
			double positiveLowerLeft, double positiveLowerRight,
			double positiveUpperLeft, double positiveUpperRight,
			double zeroLowerLeft, double zeroLowerLeftMiddle,
			double zeroLowerRightMiddle, double zeroLowerRight,
			double zeroUpperLeft, double zeroUpperLeftMiddle,
			double zeroUpperRightMiddle, double zeroUpperRight,
		...
		createNegativeMF(negativeLowerLeft, negativeLowerRight,
				negativeUpperLeft, negativeUpperRight);
		createPositiveMF(positiveLowerLeft, positiveLowerRight,
				positiveUpperLeft, positiveUpperRight);
		createZeroMF(zeroLowerLeft, zeroLowerLeftMiddle, zeroLowerRightMiddle,
				zeroLowerRight, zeroUpperLeft, zeroUpperLeftMiddle,
				zeroUpperRightMiddle, zeroUpperRight);
		createAntecedents();
	 ...
	 */
	private void createNegativeMF(double negativeLowerLeft,
			double negativeLowerRight, double negativeUpperLeft,
			double negativeUpperRight) {
		// Membership function - Negative. Definition
		negativeLowerMF = new T1MF_Trapezoidal("Lower MF Negative",
				new double[] { -180.0, -180.0, negativeLowerLeft,
						negativeLowerRight });
		negativeUpperMF = new T1MF_Trapezoidal("Upper MF Negative",
				new double[] { -180.0, -180.0, negativeUpperLeft,
						negativeUpperRight });
		negativeMF = new IntervalT2MF_Trapezoidal("IT2MF Negative",
				negativeUpperMF, negativeLowerMF);
	}
	 ...
	 */
	private void createPositiveMF(double positiveLowerLeft,
			double positiveLowerRight, double positiveUpperLeft,
			double positiveUpperRight) {
		// Membership function - positive. Definition
		positiveLowerMF = new T1MF_Trapezoidal("Lower MF Positive",
				new double[] { positiveLowerLeft, positiveLowerRight, 180.0,
						180.0 });
		positiveUpperMF = new T1MF_Trapezoidal("Upper MF Positive",
				new double[] { positiveUpperLeft, positiveUpperRight, 180.0,
						180.0 });
		positiveMF = new IntervalT2MF_Trapezoidal("IT2MF Positive",
				positiveUpperMF, positiveLowerMF);
	}
	 ...
	 * 
	 */
	private void createZeroMF(double zeroLowerLeft, double zeroLowerLeftMiddle,
			double zeroLowerRightMiddle, double zeroLowerRight,
			double zeroUpperLeft, double zeroUpperLeftMiddle,
			double zeroUpperRightMiddle, double zeroUpperRight) {
		// Membership function - zero. Definition
		zeroLowerMF = new T1MF_Trapezoidal("Lower MF Zero", new double[] {
				zeroLowerLeft, zeroLowerLeftMiddle, zeroLowerRightMiddle,
				zeroLowerRight });
		zeroUpperMF = new T1MF_Trapezoidal("Upper MF Zero", new double[] {
				zeroUpperLeft, zeroUpperLeftMiddle, zeroUpperRightMiddle,
				zeroUpperRight });
		zeroMF = new IntervalT2MF_Trapezoidal("IT2MF Zero", zeroUpperMF,
				zeroLowerMF);
	}
	...
	protected void createRulebase(IT2_Consequent leftWheelLow,
		...
		rulebase.addRule(new IT2_Rule(new IT2_Antecedent[] { negative },
				new IT2_Consequent[] { leftWheelHigh, rightWheelLow }));
		rulebase.addRule(new IT2_Rule(new IT2_Antecedent[] { zero },
				new IT2_Consequent[] { leftWheelMedium, rightWheelMedium }));
		rulebase.addRule(new IT2_Rule(new IT2_Antecedent[] { positive },
