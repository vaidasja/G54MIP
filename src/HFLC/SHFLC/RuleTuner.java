...
public class RuleTuner {
	...
	public RuleTuner() {
		...
		double[][] sampleInput = { { 500, 500, 250, 250 },
				{ 600, 600, 300, 200 }, { 800, 800, 400, 100 },
				{ 550, 500, 275, 250 }, { 500, 550, 250, 275 },
				{ 400, 400, 200, 300 }, { 200, 200, 100, 400 } };
		...
		IT2_Consequent[] leftList = { leftWheelLow, leftWheelMedium,
				leftWheelHigh };
		IT2_Consequent[] rightList = { rightWheelLow, rightWheelMedium,
				rightWheelHigh };
								...
								for (IT2_Consequent c7 : leftList) {
									for (IT2_Consequent c8 : rightList) {
										...
										rulebase.addRule(new IT2_Rule(
												...
												new IT2_Consequent[] { c1, c2 }));
										rulebase.addRule(new IT2_Rule(
												new IT2_Antecedent[] {
														closeFront, farBack },
												new IT2_Consequent[] { c3, c4 }));
										rulebase.addRule(new IT2_Rule(
												new IT2_Antecedent[] {
														farFront, closeBack },
												new IT2_Consequent[] { c5, c6 }));
										rulebase.addRule(new IT2_Rule(
												new IT2_Antecedent[] {
														farFront, farBack },
												new IT2_Consequent[] { c7, c8 }));
										...
										for (int o = 0; o < 7; o++) {
											...
											double leftOutput = rulebase
													.evaluate(0).get(
															leftWheelVelocity);
											double rightOutput = rulebase
													.evaluate(0).get(
															rightWheelVelocity);
